...
function Swipper() {
  ...
  return (
    <div className=" relative  bg-[#000000]">
      ...
      <button
        ref={prevRef}
        className="absolute left-30 top-[1700px] -translate-y-1/2 z-10 text-3xl p-2 bg-orange-500 text-white rounded-full hover:bg-orange-600"
      >
        <GrFormPrevious />
      </button>
      <button
        ref={nextRef}
        className="absolute right-45 top-[1700px] -translate-y-1/2 z-10 text-3xl p-2 bg-orange-500 text-white rounded-full hover:bg-orange-600"
      >
      ...
      >
        {images.map((img, index) => (
          <SwiperSlide key={index} className="flex  ">
            <img src={img} alt={`Product ${index + 1}`} className="w-[250px]" />
          </SwiperSlide>
        ))}
      </Swiper>
    ...
    <p className="text-[rgba(171,87,45,1)] text-[55px] justify-center flex mt-[60px]">Latest Articles</p>
     ...
     <button
        ref={prevRef}
        className="absolute left-30 top-[4800px] -translate-y-1/2 z-10 text-3xl p-2 bg-orange-500 text-white rounded-full hover:bg-orange-600"
      >
        <GrFormPrevious />
      </button>
      <button
        ref={nextRef}
        className="absolute right-45 top-[4800px] -translate-y-1/2 z-10 text-3xl p-2 bg-orange-500 text-white rounded-full hover:bg-orange-600"
      >
        <MdOutlineNavigateNext />
      </button>
      <Swiper
